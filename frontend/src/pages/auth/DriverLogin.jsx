...
export default function DriverLogin() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-700 via-orange-600 to-amber-600 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="bg-white rounded-3xl shadow-2xl overflow-hidden">
          <div className="bg-gradient-to-r from-orange-500 to-amber-600 p-8 text-white text-center">
            ...
            <h1 className="text-2xl font-black">Driver Login</h1>
            <p className="text-orange-100 text-sm mt-1">Accept deliveries, track routes, save food</p>
          </div>
          <form onSubmit={handleSubmit} className="p-8 space-y-5">
            ...
            <button type="submit" disabled={loading} className="w-full bg-orange-500 hover:bg-orange-600 disabled:opacity-60 text-white font-bold py-3 rounded-xl transition-all flex items-center justify-center gap-2">
              {loading ? <div className="w-5 h-5 border-2 border-white border-t-transparent rounded-full animate-spin" /> : <><LogIn size={18} /> Login as Driver</>}
            </button>
